/**
 * SOAP client interface (generated). DTOs: @application/dto/fex/service-soap12.types
 * Regenerate: npm run generate:soap-interfaces
 */
export * from "@application/dto/fex/service-soap12.types";
...
} from "@application/dto/fex/service-soap12.types";
