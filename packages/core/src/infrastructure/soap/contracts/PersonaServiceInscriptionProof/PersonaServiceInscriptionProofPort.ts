/**
 * SOAP client interface (generated). DTOs: @application/dto/register/persona-service-inscription-proof.types
 * Regenerate: npm run generate:soap-interfaces
 */
export * from "@application/dto/register/persona-service-inscription-proof.types";
...
} from "@application/dto/register/persona-service-inscription-proof.types";
