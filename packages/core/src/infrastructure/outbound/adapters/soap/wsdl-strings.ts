/**
 * WSDL Strings
 * Contains the WSDL content for all services
 * Auto-generated by update-wsdl-strings.js
 */

export const wsdlStrings: Record<string, string> = {
...
export const getWsdlString = (wsdlName: string): string | undefined => {
  return wsdlStrings[wsdlName];
};
