...
describe("Electronic Billings Service", () => {
  ...
  beforeEach(() => {
    ...
    const createVoucherResult: CreateVoucherResultDto = {
      response: {
  ...
  it("should get currencies types", async () => {
    const currencyTypes = await electronicBillingService.getCurrencyTypes();
  ...
  it("should get Options types", async () => {
    const optionsTypes = await electronicBillingService.getOptionalTypes();
